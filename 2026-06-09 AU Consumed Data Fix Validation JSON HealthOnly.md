...
| context_recompute | 9 | 51 | 112 | 59 | 172 | 17 | 0.3734 | 101 | G +1, Good +7, Pass +2, Win +3, Place +10 (+2.58pp), 0H -2, MRR +0.0001 |

### Changed Examples: all / context_recompute

- 2026-06-08 Canterbury Race 1-8 R3: `[7, 1, 8, 3]` -> `[8, 3, 1, 9]`
- 2026-06-08 Canterbury Race 1-8 R4: `[1, 6, 4, 5]` -> `[1, 4, 6, 7]`
- 2026-06-08 Canterbury Race 1-8 R5: `[3, 4, 8, 5]` -> `[3, 4, 8, 6]`
- 2026-06-08 Canterbury Race 1-8 R6: `[10, 8, 2, 5]` -> `[8, 10, 5, 2]`
...
| context_recompute | 6 | 22 | 41 | 26 | 69 | 6 | 0.4308 | 36 | G +0, Good +4, Pass -1, Win +3, Place +3 (+2.13pp), 0H +1, MRR +0.0253 |
