...
def refactor_agent(target_path, resources_dir):
    ...
    for line in lines:
        ...
        elif '## Step 4: NBA Analyst Orchestration' in line or '## Step 3: NBA Analyst Orchestration' in line or '## Step 5: NBA Analyst Orchestration' in line:
            capture_mode = None
            new_skill_md.append(line)
            continue
            
        elif '## Step 6: ' in line or '## Step 5: ' in line:
            capture_mode = None
            new_skill_md.append(line)
            continue
        ...
        elif '## Step 8: ' in line or '## Step 7: ' in line:
            capture_mode = None
            new_skill_md.append(line)
            continue
...
print("\nRefactoring NBA Wong Choi...")
refactor_agent(nba_target, nba_res)
