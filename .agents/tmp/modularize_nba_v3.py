...
def refactor_nba_agent(target_path, resources_dir):
    ...
    for line in lines:
        if 'ENGINE ADAPTATION' in line and line.startswith('#'):
        ...
        elif 'Pre-Flight Environment Scan' in line and line.startswith('##'):
            capture_mode = None
            
        elif '## Step 2-3:' in line:
            capture_mode = '00_nba_pipeline.md'
            new_skill_md.append('> **[Resource Reference]** Step 2-3 的分析管線流程已移至 `resources/00_nba_pipeline.md`\n')
