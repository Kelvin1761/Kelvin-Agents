...
| `frontend-specialist`    | Web UI/UX                  | frontend-design, react-best-practices, web-design-guidelines |
...
| `agent_architect`         | Agent design & skill builder |
| `rust-pro`                | Rust 1.75+ systems dev      |

### Domain-Specific (Prediction & Analytics)

| Skill                        | Description                    |
| ---------------------------- | ------------------------------ |
| `hkjc_racing`                | HKJC horse racing analysis     |
| `au_racing`                  | Australian racing analysis     |
...
| `/lol-predict`            | LoL esports prediction      |
| `/lol-reflect`            | LoL post-match analysis     |
| `/race_analysis_workflow` | Racing analysis pipeline    |
| `/safe-write`             | Safe file writing (GDrive)  |
| `/safe_write`             | Anti-lock write protocol    |
...
| **Coverage**        | ~90% web/mobile + prediction  |
