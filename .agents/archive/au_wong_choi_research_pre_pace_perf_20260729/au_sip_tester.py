#!/usr/bin/env python3
# ARCHIVED: depends on the removed rank_adjustments module.
"""
...
# Historical diagnosis: "stability" and pace performance were overtrusted on wet tracks.
...
def sip6_overrated_shield(horses, race):
    for h in horses:
        ...
        pace_perf = matrix_score(matrix_scores, "pace_perf")
        ...
        if stability >= 78 and form_line >= 76 and pace_perf < 66:
            penalty -= 0.8
