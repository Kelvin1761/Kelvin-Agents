...
| | Step 11 形勢與走位 | **Step 10** 段速修正判斷 | 走位累積消耗等級 |
| | Step 12 寬恕 | **Step 11** 走位累積消耗達「中等」自動加入 | 寬恕結論 |
...
3. Step 10 的段速修正判斷必須作為 Step 11 形勢與走位 的判斷基準。
4. Step 11 走位累積消耗達「中等」或以上時,自動加入 Step 12 寬恕因素清單。
