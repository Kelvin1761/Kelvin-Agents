...
- FAIL walk-forward: failed log loss, Brier, winner Top-3, Top-3 capture@5, 0-hit rate.
...
- FAIL Top-2 overlay: the strongest Place overlay reduced walk-forward 0-hit races (25.5%→24.8%) but cut external Top-3 capture@5 to 59.3%; this is not a safe third-pick promotion rule.
