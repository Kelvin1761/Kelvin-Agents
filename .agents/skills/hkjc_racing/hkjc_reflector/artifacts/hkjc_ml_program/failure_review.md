...
|---|---:|---:|---:|
| #1 北地烈馬 | 1 | 4 / 0.140 | 4 / 0.140 |
| #2 馬馳登 | 2 | 3 / 0.141 | 3 / 0.141 |
| #5 奇異歡星 | 3 | 2 / 0.159 | 2 / 0.159 |

Overrated Top-2 review: #7 川河石駒 (actual 5, p=0.163).
...
Systematicity: this pattern occurs in 81 weak races; any change must still improve multiple chronological folds and external evidence.
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 肥仔精神 | 1 | 12 / 0.021 | 12 / 0.021 |
| #8 巴閉佬 | 2 | 3 / 0.125 | 3 / 0.125 |
| #13 添喜運 | 3 | 1 / 0.218 | 1 / 0.218 |

Overrated Top-2 review: #7 雪茄福星 (actual 10, p=0.127).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 㩒住贏 | 1 | 8 / 0.047 | 8 / 0.047 |
| #11 富國兄弟 | 2 | 3 / 0.148 | 3 / 0.148 |
| #3 手機錶勁 | 3 | 5 / 0.099 | 5 / 0.099 |

Overrated Top-2 review: #4 超寫意 (actual 9, p=0.202)；#10 辣得準 (actual 7, p=0.154).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 團結勇士 | 1 | 4 / 0.106 | 4 / 0.106 |
| #13 幸運糖 | 2 | 9 / 0.038 | 9 / 0.038 |
| #14 飛來閃耀 | 3 | 8 / 0.068 | 8 / 0.068 |

Overrated Top-2 review: #2 米奇 (actual 7, p=0.170)；#1 會長之寶 (actual 9, p=0.151).
...
Systematicity: this pattern occurs in 47 weak races; any change must still improve multiple chronological folds and external evidence.
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #4 錶之星河 | 1 | 2 / 0.171 | 2 / 0.171 |
| #2 翠紅 | 2 | 6 / 0.072 | 6 / 0.072 |
| #12 威利金箭 | 3 | 5 / 0.076 | 5 / 0.076 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 焦點 | 1 | 1 / 0.186 | 1 / 0.186 |
| #3 駟跑得 | 2 | 9 / 0.054 | 9 / 0.054 |
| #12 華美之威 | 3 | 11 / 0.041 | 11 / 0.041 |

Overrated Top-2 review: #11 龍又生 (actual 10, p=0.152).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 拉合爾 | 1 | 1 / 0.131 | 1 / 0.131 |
| #10 致力之城 | 2 | 3 / 0.109 | 3 / 0.109 |
| #4 鄉村威龍 | 3 | 4 / 0.104 | 4 / 0.104 |

Overrated Top-2 review: #1 日出東方 (actual 10, p=0.122).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 快樂高球 | 1 | 7 / 0.077 | 7 / 0.077 |
| #11 東方寶寶 | 2 | 4 / 0.088 | 4 / 0.088 |
| #5 後無來者 | 3 | 2 / 0.120 | 2 / 0.120 |

Overrated Top-2 review: #4 首駿 (actual 5, p=0.128).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 自動自覺 | 1 | 8 / 0.065 | 8 / 0.065 |
| #4 實力加 | 2 | 5 / 0.078 | 5 / 0.078 |
| #3 八仟好運 | 3 | 4 / 0.096 | 4 / 0.096 |

Overrated Top-2 review: #2 哥倫布 (actual 5, p=0.152)；#12 瀧澤飛駒 (actual 4, p=0.137).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 夢照發 | 1 | 3 / 0.104 | 3 / 0.104 |
| #7 佰勝金龍 | 2 | 8 / 0.049 | 8 / 0.049 |
| #5 超開心 | 3 | 1 / 0.188 | 1 / 0.188 |

Overrated Top-2 review: #4 赤風驪 (actual 11, p=0.108).
...
| #13 飛躍成就 | 2 | 12 / 0.033 | 12 / 0.033 |
| #7 洪才 | 3 | 2 / 0.136 | 2 / 0.136 |

Overrated Top-2 review: #12 星光快驅 (actual 9, p=0.171).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 星火燎原 | 1 | 8 / 0.070 | 8 / 0.070 |
| #8 星辰千帥 | 2 | 7 / 0.073 | 7 / 0.073 |
| #4 佐治傳奇 | 3 | 1 / 0.190 | 1 / 0.190 |

Overrated Top-2 review: #9 有盈勇士 (actual 12, p=0.124).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 有情有義 | 1 | 1 / 0.244 | 1 / 0.244 |
| #10 北海盜 | 2 | 3 / 0.093 | 3 / 0.093 |
| #3 財富非凡 | 3 | 4 / 0.087 | 4 / 0.087 |

Overrated Top-2 review: #12 多利神駒 (actual 7, p=0.104).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 紫辰之星 | 1 | 3 / 0.150 | 3 / 0.150 |
| #4 泰力 | 2 | 6 / 0.053 | 6 / 0.053 |
| #5 做好自己 | 3 | 5 / 0.070 | 5 / 0.070 |

Overrated Top-2 review: #1 滿心星 (actual 6, p=0.227)；#3 開心勇駒 (actual 9, p=0.181).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 威力非凡 | 1 | 1 / 0.119 | 1 / 0.119 |
| #14 勁爽 | 2 | 13 / 0.041 | 13 / 0.041 |
| #6 神駒馬靈 | 3 | 3 / 0.097 | 3 / 0.097 |

Overrated Top-2 review: #7 志醒大將 (actual 4, p=0.100).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 大回報 | 1 | 1 / 0.155 | 1 / 0.155 |
| #13 幸運威龍 | 2 | 4 / 0.087 | 4 / 0.087 |
| #4 逍遙騎士 | 3 | 3 / 0.090 | 3 / 0.090 |

Overrated Top-2 review: #7 旌採 (actual 4, p=0.098).
...
## 2026-05-24 R9 — model Top-2 hits 1, Matrix 1

Classification: **contender captured in Top-5 tier but not Top 2**. Predictability review: **normal-result cohort**. Venue 沙田, Turf, 1400m, Class 4.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 韋金主 | 1 | 1 / 0.165 | 1 / 0.165 |
| #11 至尊高超 | 2 | 4 / 0.127 | 4 / 0.127 |
| #7 千帆駒 | 3 | 3 / 0.138 | 3 / 0.138 |

Overrated Top-2 review: #1 健康愉快 (actual 9, p=0.141).
Pre-race signal review: #5 韋金主: stability 78.3 (+19.7 vs field), sectional 67.2 (+9.1 vs field)；#11 至尊高超: sectional 64.4 (+6.3 vs field), trainer_signal 78.3 (+5.9 vs field)；#7 千帆駒: stability 74.4 (+15.8 vs field), sectional 69.8 (+11.7 vs field).
Cause assessment: competitive tier was identified; remaining error is ranking/weight calibration.
Systematicity: this pattern occurs in 81 weak races; any change must still improve multiple chronological folds and external evidence.
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 煌上 | 1 | 1 / 0.134 | 1 / 0.134 |
| #13 閃電小子 | 2 | 10 / 0.039 | 10 / 0.039 |
| #1 得道猴王 | 3 | 13 / 0.028 | 13 / 0.028 |

Overrated Top-2 review: #12 鈁糖武士 (actual 9, p=0.133).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 朗日自強 | 1 | 3 / 0.129 | 3 / 0.129 |
| #11 天下寵兒 | 2 | 10 / 0.052 | 10 / 0.052 |
| #9 頑童 | 3 | 11 / 0.050 | 11 / 0.050 |

Overrated Top-2 review: #1 紅愛舍 (actual 9, p=0.168)；#2 贏得自然 (actual 10, p=0.148).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 穿甲金鷹 | 1 | 1 / 0.257 | 1 / 0.257 |
| #6 智勇名駒 | 2 | 9 / 0.044 | 9 / 0.044 |
| #5 納百川 | 3 | 7 / 0.070 | 7 / 0.070 |

Overrated Top-2 review: #8 凡凡有餘 (actual 8, p=0.146).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 風采人生 | 1 | 1 / 0.264 | 1 / 0.264 |
| #8 花好月盈 | 2 | 3 / 0.132 | 3 / 0.132 |
| #7 牛精新星 | 3 | 8 / 0.044 | 8 / 0.044 |

Overrated Top-2 review: #5 環球英雄 (actual 6, p=0.217).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 幸運愉快 | 1 | 6 / 0.086 | 6 / 0.086 |
| #12 精益大師 | 2 | 10 / 0.040 | 10 / 0.040 |
| #6 新力 | 3 | 5 / 0.090 | 5 / 0.090 |

Overrated Top-2 review: #3 千杯敬典 (actual 9, p=0.162)；#11 良駒好友 (actual 5, p=0.137).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 八駿巨昇 | 1 | 9 / 0.043 | 9 / 0.043 |
| #1 馬力 | 2 | 1 / 0.166 | 1 / 0.166 |
| #2 燭光晚餐 | 3 | 3 / 0.132 | 3 / 0.132 |

Overrated Top-2 review: #10 飛龍在天 (actual 7, p=0.166).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #4 首駿 | 1 | 3 / 0.097 | 3 / 0.097 |
| #3 金風萬里 | 2 | 2 / 0.111 | 2 / 0.111 |
| #12 快馬加鞭 | 3 | 7 / 0.066 | 7 / 0.066 |

Overrated Top-2 review: #2 喆喆友福 (actual 5, p=0.291).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 星運少爵 | 1 | 2 / 0.223 | 2 / 0.223 |
| #4 喵喵怪 | 2 | 8 / 0.034 | 8 / 0.034 |
| #5 銳目 | 3 | 4 / 0.127 | 4 / 0.127 |

Overrated Top-2 review: #7 獵寶勤 (actual 6, p=0.223).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 挺秀弘利 | 1 | 4 / 0.086 | 4 / 0.086 |
| #6 八仟好運 | 2 | 2 / 0.116 | 2 / 0.116 |
| #7 北極之錶 | 3 | 3 / 0.115 | 3 / 0.115 |

Overrated Top-2 review: #2 龍城強將 (actual 6, p=0.128).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 超寫意 | 1 | 1 / 0.155 | 1 / 0.155 |
| #6 㩒住贏 | 2 | 3 / 0.119 | 3 / 0.119 |
| #2 愛馬善 | 3 | 12 / 0.026 | 12 / 0.026 |

Overrated Top-2 review: #1 得道猴王 (actual 4, p=0.130).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 喜慶寶 | 1 | 4 / 0.117 | 4 / 0.117 |
| #5 魔術控制 | 2 | 10 / 0.047 | 10 / 0.047 |
| #9 威利金箭 | 3 | 3 / 0.118 | 3 / 0.118 |

Overrated Top-2 review: #6 扶搖勢勁 (actual 5, p=0.135)；#3 維港智能 (actual 4, p=0.132).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 家樂寶駒 | 1 | 4 / 0.120 | 4 / 0.120 |
| #1 竣誠駒 | 2 | 3 / 0.127 | 3 / 0.127 |
| #10 龍又生 | 3 | 2 / 0.129 | 2 / 0.129 |

Overrated Top-2 review: #5 君智盛 (actual 7, p=0.141).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 高高至高 | 1 | 4 / 0.097 | 4 / 0.097 |
| #7 準希望 | 2 | 1 / 0.198 | 1 / 0.198 |
| #6 得意佳作 | 3 | 9 / 0.051 | 9 / 0.051 |

Overrated Top-2 review: #5 大千氣象 (actual 5, p=0.183).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 風火猴王 | 1 | 5 / 0.089 | 5 / 0.089 |
| #11 友得盈 | 2 | 8 / 0.065 | 8 / 0.065 |
| #5 勝多多 | 3 | 7 / 0.067 | 7 / 0.067 |

Overrated Top-2 review: #9 良駒好友 (actual 6, p=0.158)；#7 豪邁先登 (actual 8, p=0.148).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 鴻圖新星 | 1 | 1 / 0.220 | 1 / 0.220 |
| #5 美麗登場 | 2 | 4 / 0.110 | 4 / 0.110 |
| #8 天火同人 | 3 | 3 / 0.127 | 3 / 0.127 |

Overrated Top-2 review: #2 紅錢到 (actual 4, p=0.127).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 爆竹 | 1 | 8 / 0.046 | 8 / 0.046 |
| #3 紅海勁 | 2 | 5 / 0.088 | 5 / 0.088 |
| #1 上浦福旺 | 3 | 1 / 0.200 | 1 / 0.200 |

Overrated Top-2 review: #5 有情有義 (actual 4, p=0.195).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 烈焰光芒 | 1 | 3 / 0.130 | 3 / 0.130 |
| #4 日馳千里 | 2 | 4 / 0.100 | 4 / 0.100 |
| #3 風采人生 | 3 | 1 / 0.234 | 1 / 0.234 |

Overrated Top-2 review: #2 巴閉王 (actual 4, p=0.219).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 極光之子 | 1 | 10 / 0.024 | 10 / 0.024 |
| #11 將義 | 2 | 2 / 0.147 | 2 / 0.147 |
| #2 川河耀駒 | 3 | 5 / 0.109 | 5 / 0.109 |

Overrated Top-2 review: #3 豐辰 (actual 4, p=0.208).
...
| #7 量子猴王 | 3 | 3 / 0.172 | 3 / 0.172 |

Overrated Top-2 review: #5 紅悅舍 (actual 4, p=0.177).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 鄉村樂韻 | 1 | 1 / 0.163 | 1 / 0.163 |
| #4 果然僥倖 | 2 | 9 / 0.052 | 9 / 0.052 |
| #12 朗日雪峰 | 3 | 5 / 0.096 | 5 / 0.096 |

Overrated Top-2 review: #3 機械騎士 (actual 8, p=0.156).
...
| #11 華麗再贏 | 2 | 1 / 0.139 | 1 / 0.139 |
| #9 遨遊波士 | 3 | 4 / 0.101 | 4 / 0.101 |

Overrated Top-2 review: #3 卓越蒨鋒 (actual 8, p=0.119).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 巴閉精 | 1 | 1 / 0.208 | 1 / 0.208 |
| #6 利高八斗 | 2 | 3 / 0.119 | 3 / 0.119 |
| #1 鼓浪好友 | 3 | 4 / 0.104 | 4 / 0.104 |

Overrated Top-2 review: #5 巧眼光 (actual 9, p=0.140).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 太陽勇士 | 1 | 4 / 0.120 | 4 / 0.120 |
| #7 一起美麗 | 2 | 2 / 0.178 | 2 / 0.178 |
| #1 睿盛人生 | 3 | 5 / 0.086 | 5 / 0.086 |

Overrated Top-2 review: #3 包裝福星 (actual 6, p=0.202).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 櫻花酒杯 | 1 | 3 / 0.118 | 3 / 0.118 |
| #3 綠野飛馳 | 2 | 2 / 0.150 | 2 / 0.150 |
| #4 超勁赤兔 | 3 | 8 / 0.064 | 8 / 0.064 |

Overrated Top-2 review: #7 友瑩亮 (actual 5, p=0.155).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 極速神影 | 1 | 7 / 0.059 | 7 / 0.059 |
| #7 致力之城 | 2 | 2 / 0.134 | 2 / 0.134 |
| #9 紅海旺 | 3 | 5 / 0.070 | 5 / 0.070 |

Overrated Top-2 review: #8 將傲 (actual 4, p=0.134).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 包裝明將 | 1 | 2 / 0.106 | 2 / 0.106 |
| #5 祥勝鷹駒 | 2 | 4 / 0.077 | 4 / 0.077 |
| #8 彪形勇將 | 3 | 14 / 0.017 | 14 / 0.017 |

Overrated Top-2 review: #2 博愛先鋒 (actual 4, p=0.240).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 超和平 | 1 | 5 / 0.062 | 5 / 0.062 |
| #3 鋁神 | 2 | 1 / 0.191 | 1 / 0.191 |
| #11 馬鳳凰 | 3 | 9 / 0.051 | 9 / 0.051 |

Overrated Top-2 review: #7 熱氣球 (actual 10, p=0.175).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 逍遙騎士 | 1 | 3 / 0.132 | 3 / 0.132 |
| #4 包裝戰仕 | 2 | 11 / 0.034 | 11 / 0.034 |
| #12 好運年 | 3 | 5 / 0.083 | 5 / 0.083 |

Overrated Top-2 review: #2 深心星 (actual 5, p=0.210)；#10 家傳之寶 (actual 4, p=0.149).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 朗日雪峰 | 1 | 1 / 0.157 | 1 / 0.157 |
| #1 新力驕 | 2 | 9 / 0.054 | 9 / 0.054 |
| #2 鄉村樂韻 | 3 | 3 / 0.111 | 3 / 0.111 |

Overrated Top-2 review: #3 本能 (actual 14, p=0.119).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 正極 | 1 | 4 / 0.100 | 4 / 0.100 |
| #5 千杯敬典 | 2 | 7 / 0.066 | 7 / 0.066 |
| #8 合夥智能 | 3 | 9 / 0.048 | 9 / 0.048 |

Overrated Top-2 review: #10 小魔怪 (actual 7, p=0.133)；#6 團結戰靈 (actual 4, p=0.124).
...
Classification: **competitive group absent from both Top-5 rankings**. Predictability review: **normal-result cohort**. Venue 沙田, AWT, 1650m, Class 4.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #10 午夜快車 | 1 | 6 / 0.070 | 6 / 0.070 |
| #12 林寶精神 | 2 | 11 / 0.046 | 11 / 0.046 |
| #4 超加加 | 3 | 3 / 0.104 | 3 / 0.104 |

Overrated Top-2 review: #2 奮鬥心 (actual 5, p=0.157)；#5 精彩動力 (actual 6, p=0.121).
...
| #4 老鼠斑 | 2 | 9 / 0.055 | 9 / 0.055 |
| #1 怡昌光輝 | 3 | 4 / 0.082 | 4 / 0.082 |

Overrated Top-2 review: #3 風采人生 (actual 10, p=0.193)；#10 快樂高球 (actual 5, p=0.098).
...
| #7 魔術控制 | 2 | 3 / 0.108 | 3 / 0.108 |
| #3 天天同樂 | 3 | 4 / 0.100 | 4 / 0.100 |

Overrated Top-2 review: #8 勇敢巨星 (actual 11, p=0.166)；#2 星際快車 (actual 5, p=0.129).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 精英雄心 | 1 | 2 / 0.125 | 2 / 0.125 |
| #14 正義波 | 2 | 11 / 0.051 | 11 / 0.051 |
| #12 都靈福星 | 3 | 7 / 0.065 | 7 / 0.065 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 天比高 | 1 | 3 / 0.100 | 3 / 0.100 |
| #13 海洋帝君 | 2 | 5 / 0.093 | 5 / 0.093 |
| #4 劍無情 | 3 | 1 / 0.202 | 1 / 0.202 |

Overrated Top-2 review: #1 勇敢孖寶 (actual 12, p=0.104).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 拉合爾 | 1 | 2 / 0.146 | 2 / 0.146 |
| #3 凝聚美麗 | 2 | 5 / 0.073 | 5 / 0.073 |
| #7 赤兔再世 | 3 | 4 / 0.078 | 4 / 0.078 |

Overrated Top-2 review: #13 天天更好 (actual 10, p=0.210).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 團結勇士 | 1 | 7 / 0.081 | 7 / 0.081 |
| #12 幸運糖 | 2 | 1 / 0.125 | 1 / 0.125 |
| #2 會長之寶 | 3 | 3 / 0.110 | 3 / 0.110 |

Overrated Top-2 review: #5 精彩福星 (actual 4, p=0.122).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 嵐臣 | 1 | 2 / 0.121 | 2 / 0.121 |
| #4 美麗大獎 | 2 | 3 / 0.111 | 3 / 0.111 |
| #7 龍城強將 | 3 | 9 / 0.055 | 9 / 0.055 |

Overrated Top-2 review: #10 挺秀弘利 (actual 5, p=0.172).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 旌採 | 1 | 1 / 0.183 | 1 / 0.183 |
| #11 幸運威龍 | 2 | 8 / 0.058 | 8 / 0.058 |
| #12 君達得 | 3 | 4 / 0.105 | 4 / 0.105 |
...
## 2026-07-01 R11 — model Top-2 hits 1, Matrix 1
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 馬達 | 1 | 3 / 0.143 | 3 / 0.143 |
| #4 金金小子 | 2 | 7 / 0.071 | 7 / 0.071 |
| #3 㩒住贏 | 3 | 1 / 0.166 | 1 / 0.166 |

Overrated Top-2 review: #2 財將 (actual 12, p=0.144).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #4 扶搖勢勁 | 1 | 1 / 0.193 | 1 / 0.193 |
| #6 巴基之勝 | 2 | 5 / 0.109 | 5 / 0.109 |
| #3 競駿輝煌 | 3 | 4 / 0.150 | 4 / 0.150 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 致力之城 | 1 | 2 / 0.178 | 2 / 0.178 |
| #6 砂漿麒星 | 2 | 8 / 0.057 | 8 / 0.057 |
| #11 瑤瑤日上 | 3 | 7 / 0.057 | 7 / 0.057 |

Overrated Top-2 review: #1 葳莉非凡 (actual 11, p=0.213).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 實力股 | 1 | 5 / 0.073 | 5 / 0.073 |
| #6 巴閉精 | 2 | 2 / 0.253 | 2 / 0.253 |
| #12 辣得準 | 3 | 3 / 0.099 | 3 / 0.099 |

Overrated Top-2 review: #1 精彩駿將 (actual 4, p=0.257).
...
## 2026-07-04 R11 — model Top-2 hits 1, Matrix 1

Classification: **contender captured in Top-5 tier but not Top 2**. Predictability review: **normal-result cohort**. Venue 沙田, Turf, 1400m, Class 3.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 超輕鬆 | 1 | 6 / 0.077 | 6 / 0.077 |
| #5 安泰 | 2 | 3 / 0.099 | 3 / 0.099 |
| #11 正本唐心 | 3 | 1 / 0.180 | 1 / 0.180 |

Overrated Top-2 review: #3 粵港資駒 (actual 5, p=0.104).
Pre-race signal review: #1 超輕鬆: stability 73.9 (+19.8 vs field), form_line 96.0 (+13.4 vs field)；#5 安泰: trainer_signal 84.8 (+12.3 vs field), class_advantage 74.1 (+10.0 vs field)；#11 正本唐心: trainer_signal 87.0 (+14.5 vs field), form_line 91.0 (+8.4 vs field).
Cause assessment: competitive tier was identified; remaining error is ranking/weight calibration.
Systematicity: this pattern occurs in 81 weak races; any change must still improve multiple chronological folds and external evidence.
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 萬眾開心 | 1 | 1 / 0.201 | 1 / 0.201 |
| #1 鄉村樂韻 | 2 | 10 / 0.061 | 10 / 0.061 |
| #5 洛河 | 3 | 6 / 0.079 | 6 / 0.079 |

Overrated Top-2 review: #12 天火同德 (actual 8, p=0.148).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 暴風之子 | 1 | 5 / 0.095 | 5 / 0.095 |
| #6 贏玥 | 2 | 9 / 0.045 | 9 / 0.045 |
| #8 越駿聯歡 | 3 | 4 / 0.100 | 4 / 0.100 |

Overrated Top-2 review: #2 川河帥駒 (actual 9, p=0.202)；#9 得意佳作 (actual 10, p=0.167).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 福進 | 1 | 3 / 0.141 | 3 / 0.141 |
| #4 美麗登場 | 2 | 5 / 0.099 | 5 / 0.099 |
| #8 天火同人 | 3 | 2 / 0.157 | 2 / 0.157 |

Overrated Top-2 review: #1 鴻圖新星 (actual 4, p=0.186).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 至合拍 | 1 | 1 / 0.169 | 1 / 0.169 |
| #2 路路勁 | 2 | 6 / 0.083 | 6 / 0.083 |
| #12 頑童 | 3 | 5 / 0.084 | 5 / 0.084 |

Overrated Top-2 review: #11 川河石駒 (actual 12, p=0.125).
...
Classification: **competitive group absent from both Top-5 rankings**. Predictability review: **normal-result cohort**. Venue 跑馬地, Turf, 1000m, Class 3.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 舞林寶典 | 1 | 11 / 0.036 | 11 / 0.036 |
| #1 燭光晚餐 | 2 | 4 / 0.092 | 4 / 0.092 |
| #3 品德寶寶 | 3 | 6 / 0.073 | 6 / 0.073 |

Overrated Top-2 review: #2 連連幸運 (actual 9, p=0.204)；#5 加州本事 (actual 5, p=0.163).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 特別美麗 | 1 | 7 / 0.075 | 7 / 0.075 |
| #11 龍又生 | 2 | 2 / 0.103 | 2 / 0.103 |
| #2 光輝歲月 | 3 | 5 / 0.085 | 5 / 0.085 |

Overrated Top-2 review: #4 連連好運 (actual 5, p=0.152).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 東方寶寶 | 1 | 1 / 0.154 | 1 / 0.154 |
| #6 籐王駒 | 2 | 12 / 0.034 | 12 / 0.034 |
| #11 海洋帝君 | 3 | 3 / 0.126 | 3 / 0.126 |

Overrated Top-2 review: #10 星之願 (actual 4, p=0.130).
...
| #9 嘉應駿昇 | 2 | 13 / 0.029 | 13 / 0.029 |
| #10 遨遊波士 | 3 | 3 / 0.138 | 3 / 0.138 |

Overrated Top-2 review: #13 勤德皆備 (actual 8, p=0.184).
...
| #12 快樂高球 | 2 | 2 / 0.130 | 2 / 0.130 |
| #1 渡月橋 | 3 | 4 / 0.118 | 4 / 0.118 |

Overrated Top-2 review: #3 嘉應駿馬 (actual 6, p=0.144).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #13 名揚四海 | 1 | 6 / 0.078 | 6 / 0.078 |
| #4 一生好彩 | 2 | 2 / 0.121 | 2 / 0.121 |
| #12 大回報 | 3 | 4 / 0.093 | 4 / 0.093 |

Overrated Top-2 review: #7 超勁赤兔 (actual 7, p=0.136).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 鵲橋飛昇 | 1 | 7 / 0.073 | 7 / 0.073 |
| #2 銳行星 | 2 | 3 / 0.120 | 3 / 0.120 |
| #6 永福 | 3 | 8 / 0.073 | 8 / 0.073 |

Overrated Top-2 review: #1 全能勇士 (actual 5, p=0.171)；#7 極歡欣 (actual 4, p=0.141).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #10 一舖掂晒 | 1 | 12 / 0.014 | 12 / 0.014 |
| #4 支付之父 | 2 | 2 / 0.134 | 2 / 0.134 |
| #11 致力之城 | 3 | 10 / 0.022 | 10 / 0.022 |

Overrated Top-2 review: #6 鴻圖新星 (actual 12, p=0.238).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #4 君子 | 1 | 12 / 0.027 | 12 / 0.027 |
| #6 老鼠斑 | 2 | 10 / 0.034 | 10 / 0.034 |
| #2 心雄雄 | 3 | 3 / 0.121 | 3 / 0.121 |

Overrated Top-2 review: #9 星辰千帥 (actual 5, p=0.223)；#3 輝灑自如 (actual 9, p=0.147).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 龍傲綾羅 | 1 | 6 / 0.095 | 6 / 0.095 |
| #7 文明福星 | 2 | 1 / 0.141 | 1 / 0.141 |
| #3 將傲 | 3 | 9 / 0.045 | 9 / 0.045 |

Overrated Top-2 review: #9 開心旺財 (actual 8, p=0.124).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #13 金鑽精靈 | 1 | 10 / 0.045 | 10 / 0.045 |
| #8 好運年 | 2 | 8 / 0.074 | 8 / 0.074 |
| #11 君達得 | 3 | 12 / 0.029 | 12 / 0.029 |

Overrated Top-2 review: #1 威武年代 (actual 14, p=0.139)；#7 綫路福將 (actual 13, p=0.127).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #4 上浦福旺 | 1 | 12 / 0.024 | 12 / 0.024 |
| #10 滿洛城 | 2 | 3 / 0.102 | 3 / 0.102 |
| #11 獎星 | 3 | 5 / 0.092 | 5 / 0.092 |

Overrated Top-2 review: #3 睿智多寶 (actual 9, p=0.193)；#5 大千氣象 (actual 5, p=0.147).
...
| #3 縱橫天下 | 2 | 7 / 0.064 | 7 / 0.064 |
| #1 競駿非凡 | 3 | 10 / 0.043 | 10 / 0.043 |

Overrated Top-2 review: #12 勝在當下 (actual 4, p=0.150)；#10 良駒好友 (actual 6, p=0.148).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 包裝福星 | 1 | 4 / 0.117 | 4 / 0.117 |
| #4 太陽勇士 | 2 | 2 / 0.123 | 2 / 0.123 |
| #10 一起美麗 | 3 | 7 / 0.076 | 7 / 0.076 |

Overrated Top-2 review: #8 銀亮奔騰 (actual 4, p=0.134).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 齊歡最樂 | 1 | 5 / 0.098 | 5 / 0.098 |
| #10 捷足奔馳 | 2 | 6 / 0.065 | 6 / 0.065 |
| #7 香港精神 | 3 | 10 / 0.040 | 10 / 0.040 |

Overrated Top-2 review: #8 開心三多 (actual 6, p=0.144)；#9 幸運同行 (actual 8, p=0.138).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 小魔怪 | 1 | 7 / 0.064 | 7 / 0.064 |
| #10 天天更好 | 2 | 1 / 0.177 | 1 / 0.177 |
| #8 你知我寶 | 3 | 3 / 0.104 | 3 / 0.104 |

Overrated Top-2 review: #1 禾道豐 (actual 4, p=0.163).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #10 傑出雷霆 | 1 | 3 / 0.142 | 3 / 0.142 |
| #11 有備而戰 | 2 | 12 / 0.033 | 12 / 0.033 |
| #2 星月飛雲 | 3 | 2 / 0.152 | 2 / 0.152 |

Overrated Top-2 review: #3 健康快車 (actual 5, p=0.164).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #10 臻至辰 | 1 | 10 / 0.065 | 10 / 0.065 |
| #8 超輕鬆 | 2 | 2 / 0.107 | 2 / 0.107 |
| #6 三甲之星 | 3 | 5 / 0.077 | 5 / 0.077 |

Overrated Top-2 review: #5 安泰 (actual 9, p=0.158).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 財將 | 1 | 7 / 0.080 | 7 / 0.080 |
| #7 鴻圖新星 | 2 | 2 / 0.134 | 2 / 0.134 |
| #5 紅錢到 | 3 | 11 / 0.038 | 11 / 0.038 |

Overrated Top-2 review: #4 美麗登場 (actual 7, p=0.149).
...
| #7 扶搖勢勁 | 2 | 5 / 0.093 | 5 / 0.093 |
| #1 天天同樂 | 3 | 6 / 0.075 | 6 / 0.075 |

Overrated Top-2 review: #9 俏眼光 (actual 12, p=0.175)；#4 信心星 (actual 6, p=0.141).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 金快飛飛 | 1 | 4 / 0.095 | 4 / 0.095 |
| #1 包裝明將 | 2 | 6 / 0.081 | 6 / 0.081 |
| #2 嵐臣 | 3 | 2 / 0.106 | 2 / 0.106 |

Overrated Top-2 review: #10 隋我同來 (actual 10, p=0.147).
...
| #2 巧眼光 | 2 | 3 / 0.100 | 3 / 0.100 |
| #14 有你有我 | 3 | 4 / 0.088 | 4 / 0.088 |

Overrated Top-2 review: #4 老鼠斑 (actual 8, p=0.144)；#12 同喜 (actual 12, p=0.115).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 包裝天王 | 1 | 2 / 0.136 | 2 / 0.136 |
| #11 銀刺勇士 | 2 | 11 / 0.046 | 11 / 0.046 |
| #9 北極之錶 | 3 | 9 / 0.049 | 9 / 0.049 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 仁仁有餘 | 1 | 3 / 0.111 | 3 / 0.111 |
| #8 馬上盈 | 2 | 6 / 0.072 | 6 / 0.072 |
| #9 共創歡欣 | 3 | 10 / 0.045 | 10 / 0.045 |

Overrated Top-2 review: #14 觀萬物 (actual 9, p=0.165)；#4 馬馳登 (actual 5, p=0.132).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 勁大威猛 | 1 | 5 / 0.085 | 5 / 0.085 |
| #13 勁好運 | 2 | 4 / 0.089 | 4 / 0.089 |
| #8 幸運派彩 | 3 | 13 / 0.035 | 13 / 0.035 |

Overrated Top-2 review: #3 平凡騎士 (actual 13, p=0.148)；#1 春風萬里 (actual 10, p=0.099).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 浪漫勇士 | 1 | 1 / 0.227 | 1 / 0.227 |
| #5 數字天文 | 2 | 4 / 0.110 | 4 / 0.110 |
| #2 大怪奇 | 3 | 9 / 0.061 | 9 / 0.061 |

Overrated Top-2 review: #9 浪漫戰神 (actual 4, p=0.148).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 本能 | 1 | 4 / 0.087 | 4 / 0.087 |
| #11 東方福寶 | 2 | 11 / 0.039 | 11 / 0.039 |
| #10 星之願 | 3 | 2 / 0.163 | 2 / 0.163 |

Overrated Top-2 review: #2 魅力星 (actual 10, p=0.220).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 捷足奔馳 | 1 | 5 / 0.105 | 5 / 0.105 |
| #8 幸運同行 | 2 | 4 / 0.113 | 4 / 0.113 |
| #9 美麗多盈 | 3 | 12 / 0.026 | 12 / 0.026 |

Overrated Top-2 review: #1 管之友 (actual 7, p=0.201)；#12 同寶寶 (actual 5, p=0.135).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 小霸王 | 1 | 6 / 0.074 | 6 / 0.074 |
| #5 晶晶日上 | 2 | 7 / 0.072 | 7 / 0.072 |
| #12 椒椒醒 | 3 | 12 / 0.009 | 12 / 0.009 |

Overrated Top-2 review: #7 富心星 (actual 10, p=0.210)；#9 可靠大師 (actual 12, p=0.161).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 富裕君子 | 1 | 1 / 0.262 | 1 / 0.262 |
| #12 不假外求 | 2 | 7 / 0.046 | 7 / 0.046 |
| #6 電訊驕陽 | 3 | 12 / 0.016 | 12 / 0.016 |

Overrated Top-2 review: #9 華美之威 (actual 5, p=0.161).
...
## 2026-06-03 R3 — model Top-2 hits 0, Matrix 0

Classification: **competitive group absent from both Top-5 rankings**. Predictability review: **abnormal/outsider flagged**. Venue 跑馬地, Turf, 1200m, Class 4.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 博愛先鋒 | 1 | 4 / 0.130 | 4 / 0.130 |
| #12 有你有我 | 2 | 6 / 0.099 | 6 / 0.099 |
| #4 驕陽雄心 | 3 | 9 / 0.043 | 9 / 0.043 |

Overrated Top-2 review: #3 團長好 (actual 10, p=0.185)；#9 神異金剛 (actual 7, p=0.133).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 先到先得 | 1 | 3 / 0.127 | 3 / 0.127 |
| #1 星願無限 | 2 | 10 / 0.032 | 10 / 0.032 |
| #9 獎星 | 3 | 2 / 0.187 | 2 / 0.187 |

Overrated Top-2 review: #10 時間寶 (actual 12, p=0.209).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 銀亮奔騰 | 1 | 1 / 0.196 | 1 / 0.196 |
| #11 奔放 | 2 | 6 / 0.065 | 6 / 0.065 |
| #4 加州動員 | 3 | 11 / 0.027 | 11 / 0.027 |

Overrated Top-2 review: #7 一起美麗 (actual 6, p=0.165).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 飛躍星伴 | 1 | 3 / 0.096 | 3 / 0.096 |
| #1 開心宇宙 | 2 | 11 / 0.045 | 11 / 0.045 |
| #3 超加加 | 3 | 9 / 0.050 | 9 / 0.050 |

Overrated Top-2 review: #9 精明選擇 (actual 4, p=0.167)；#2 凱明神駒 (actual 13, p=0.161).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 部族高手 | 1 | 3 / 0.089 | 3 / 0.089 |
| #10 捷威 | 2 | 5 / 0.085 | 5 / 0.085 |
| #5 好運年 | 3 | 13 / 0.039 | 13 / 0.039 |

Overrated Top-2 review: #1 雙星報喜 (actual 11, p=0.135)；#6 金鑽精靈 (actual 6, p=0.113).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 超輕鬆 | 1 | 5 / 0.093 | 5 / 0.093 |
| #5 自動自覺 | 2 | 2 / 0.107 | 2 / 0.107 |
| #8 勁無限 | 3 | 4 / 0.095 | 4 / 0.095 |

Overrated Top-2 review: #3 一世美麗 (actual 7, p=0.150).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 賢者威楓 | 1 | 5 / 0.087 | 5 / 0.087 |
| #4 深心星 | 2 | 7 / 0.075 | 7 / 0.075 |
| #5 龍之悅 | 3 | 6 / 0.077 | 6 / 0.077 |

Overrated Top-2 review: #9 馬上盈 (actual 6, p=0.170)；#13 共創歡欣 (actual 9, p=0.110).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 年年友福 | 1 | 9 / 0.040 | 9 / 0.040 |
| #12 天蓬貓 | 2 | 3 / 0.144 | 3 / 0.144 |
| #2 安可 | 3 | 2 / 0.154 | 2 / 0.154 |

Overrated Top-2 review: #6 超開心 (actual 4, p=0.216).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 文明戰士 | 1 | 9 / 0.068 | 9 / 0.068 |
| #2 葳莉非凡 | 2 | 4 / 0.116 | 4 / 0.116 |
| #3 逍遙人生 | 3 | 1 / 0.136 | 1 / 0.136 |

Overrated Top-2 review: #5 顯勝高昇 (actual 11, p=0.136).
...
## 2026-06-13 R9 — model Top-2 hits 1, Matrix 1
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #10 偵探傳奇 | 1 | 10 / 0.040 | 10 / 0.040 |
| #3 興馳千里 | 2 | 2 / 0.123 | 2 / 0.123 |
| #9 德心知遇 | 3 | 8 / 0.055 | 8 / 0.055 |

Overrated Top-2 review: #6 三軍勇將 (actual 6, p=0.192).
...
## 2026-06-21 R6 — model Top-2 hits 0, Matrix 0

Classification: **competitive group absent from both Top-5 rankings**. Predictability review: **abnormal/outsider flagged**. Venue 沙田, Turf, 1400m, Class 4.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 金快飛飛 | 1 | 3 / 0.110 | 3 / 0.110 |
| #12 飛躍成就 | 2 | 10 / 0.049 | 10 / 0.049 |
| #4 手機錶能 | 3 | 9 / 0.067 | 9 / 0.067 |

Overrated Top-2 review: #1 加州熱浪 (actual 8, p=0.147)；#2 天福 (actual 5, p=0.114).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 小鳥天堂 | 1 | 6 / 0.090 | 6 / 0.090 |
| #1 錶之銀河 | 2 | 4 / 0.098 | 4 / 0.098 |
| #7 幸運有您 | 3 | 10 / 0.059 | 10 / 0.059 |

Overrated Top-2 review: #2 精算暴雪 (actual 9, p=0.162)；#10 韋金主 (actual 4, p=0.136).
...
| #5 安帝 | 2 | 3 / 0.129 | 3 / 0.129 |
| #1 春風萬里 | 3 | 8 / 0.053 | 8 / 0.053 |

Overrated Top-2 review: #6 共享富裕 (actual 9, p=0.135)；#11 紫荊拼搏 (actual 12, p=0.132).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 美麗同享 | 1 | 1 / 0.142 | 1 / 0.142 |
| #3 光年魅力 | 2 | 7 / 0.089 | 7 / 0.089 |
| #11 浪漫戰神 | 3 | 10 / 0.065 | 10 / 0.065 |

Overrated Top-2 review: #7 銀亮奔騰 (actual 4, p=0.103).
...
| #4 人和家興 | 2 | 9 / 0.042 | 9 / 0.042 |
| #13 包裝天王 | 3 | 2 / 0.135 | 2 / 0.135 |

Overrated Top-2 review: #1 跨境寶馬 (actual 4, p=0.148).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 閃電小子 | 1 | 9 / 0.057 | 9 / 0.057 |
| #9 金勝名駒 | 2 | 11 / 0.038 | 11 / 0.038 |
| #1 閃耀天河 | 3 | 5 / 0.080 | 5 / 0.080 |

Overrated Top-2 review: #3 冷娃 (actual 6, p=0.143)；#11 紅運光輝 (actual 10, p=0.135).
...
| #4 翠湖烈風 | 2 | 12 / 0.036 | 12 / 0.036 |
| #3 果然僥倖 | 3 | 11 / 0.055 | 11 / 0.055 |

Overrated Top-2 review: #2 英雄豪邁 (actual 8, p=0.120)；#1 金風萬里 (actual 13, p=0.106).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 堅先生 | 1 | 1 / 0.143 | 1 / 0.143 |
| #11 香港仔 | 2 | 9 / 0.049 | 9 / 0.049 |
| #7 傑出雷霆 | 3 | 7 / 0.054 | 7 / 0.054 |

Overrated Top-2 review: #1 得道猴王 (actual 10, p=0.137).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 金牌活力 | 1 | 5 / 0.090 | 5 / 0.090 |
| #2 友瑩仁 | 2 | 3 / 0.106 | 3 / 0.106 |
| #6 綫路英雄 | 3 | 2 / 0.133 | 2 / 0.133 |

Overrated Top-2 review: #7 做好自己 (actual 4, p=0.175).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 手到再來 | 1 | 8 / 0.063 | 8 / 0.063 |
| #10 東方魅影 | 2 | 4 / 0.091 | 4 / 0.091 |
| #7 志醒大將 | 3 | 11 / 0.049 | 11 / 0.049 |

Overrated Top-2 review: #11 勁爽 (actual 4, p=0.124)；#2 平海之星 (actual 12, p=0.104).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 佛亮老撾 | 1 | 3 / 0.098 | 3 / 0.098 |
| #11 潮流勇駒 | 2 | 6 / 0.065 | 6 / 0.065 |
| #14 順善寶 | 3 | 1 / 0.203 | 1 / 0.203 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 嘉應奇兵 | 1 | 7 / 0.066 | 7 / 0.066 |
| #7 美麗星晨 | 2 | 10 / 0.027 | 10 / 0.027 |
| #8 至尊瑰寶 | 3 | 3 / 0.115 | 3 / 0.115 |

Overrated Top-2 review: #2 笑傲江湖 (actual 5, p=0.256)；#6 喜尊龍 (actual 9, p=0.154).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 魅力知福 | 1 | 3 / 0.099 | 3 / 0.099 |
| #11 駿先生 | 2 | 7 / 0.051 | 7 / 0.051 |
| #5 朗日雪峰 | 3 | 1 / 0.313 | 1 / 0.313 |

Overrated Top-2 review: #10 紅旺繽紛 (actual 7, p=0.138).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 添開心 | 1 | 4 / 0.117 | 4 / 0.117 |
| #12 同喜 | 2 | 3 / 0.138 | 3 / 0.138 |
| #6 老鼠斑 | 3 | 2 / 0.179 | 2 / 0.179 |

Overrated Top-2 review: #4 開心孖寶 (actual 10, p=0.201).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 捷威 | 1 | 1 / 0.135 | 1 / 0.135 |
| #9 風起雲湧 | 2 | 5 / 0.083 | 5 / 0.083 |
| #3 創科群英 | 3 | 13 / 0.028 | 13 / 0.028 |

Overrated Top-2 review: #12 鴻圖大展 (actual 7, p=0.124).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 利高八斗 | 1 | 1 / 0.186 | 1 / 0.186 |
| #6 龍文正道 | 2 | 6 / 0.060 | 6 / 0.060 |
| #1 鼓浪好友 | 3 | 5 / 0.066 | 5 / 0.066 |

Overrated Top-2 review: #5 應龍飛影 (actual 4, p=0.183).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 哥倫布 | 1 | 2 / 0.191 | 2 / 0.191 |
| #7 焦點 | 2 | 4 / 0.120 | 4 / 0.120 |
| #6 準希望 | 3 | 6 / 0.106 | 6 / 0.106 |

Overrated Top-2 review: #5 好運年 (actual 4, p=0.223).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 極光之子 | 1 | 10 / 0.034 | 10 / 0.034 |
| #11 幸運派彩 | 2 | 7 / 0.072 | 7 / 0.072 |
| #10 川河耀駒 | 3 | 12 / 0.018 | 12 / 0.018 |

Overrated Top-2 review: #3 奔放 (actual 9, p=0.187)；#12 將義 (actual 10, p=0.137).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 撼天鐵翼 | 1 | 3 / 0.129 | 3 / 0.129 |
| #4 觀眾之力 | 2 | 4 / 0.118 | 4 / 0.118 |
| #3 嘉應勇將 | 3 | 9 / 0.042 | 9 / 0.042 |

Overrated Top-2 review: #1 志滿同行 (actual 7, p=0.213)；#7 皇者有利 (actual 8, p=0.138).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 金滙千帥 | 1 | 1 / 0.158 | 1 / 0.158 |
| #12 金運齊來 | 2 | 10 / 0.057 | 10 / 0.057 |
| #1 哈羅威 | 3 | 8 / 0.062 | 8 / 0.062 |

Overrated Top-2 review: #5 文明福星 (actual 10, p=0.116).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 盈妍威楓 | 1 | 8 / 0.067 | 8 / 0.067 |
| #10 烈進駒 | 2 | 12 / 0.048 | 12 / 0.048 |
| #8 實力加 | 3 | 10 / 0.053 | 10 / 0.053 |

Overrated Top-2 review: #14 旭能精英 (actual 5, p=0.113)；#6 銀刺勇士 (actual 12, p=0.104).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 包裝戰仕 | 1 | 9 / 0.064 | 9 / 0.064 |
| #6 新力飆 | 2 | 14 / 0.030 | 14 / 0.030 |
| #5 超開心 | 3 | 2 / 0.104 | 2 / 0.104 |

Overrated Top-2 review: #10 天蓬貓 (actual 4, p=0.126).
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 臻至辰 | 1 | 5 / 0.083 | 5 / 0.083 |
| #12 金快飛飛 | 2 | 7 / 0.067 | 7 / 0.067 |
| #4 泰坦 | 3 | 10 / 0.041 | 10 / 0.041 |

Overrated Top-2 review: #1 綠野飛馳 (actual 5, p=0.138)；#6 閃電小子 (actual 6, p=0.134).
...
Weak races reviewed: **128** (71 normal-result cohort; 57 outsider/incident/injury/abnormal flagged). Races where the challenger improved Top-2 hit count over Matrix: **0**.

| Pattern | Races |
|---|---:|
| contender captured in Top-5 tier but not Top 2 | 81 |
| competitive group absent from both Top-5 rankings | 47 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 北地烈馬 | 1 | 5 / 0.094 | 4 / 0.140 |
| #2 馬馳登 | 2 | 4 / 0.099 | 3 / 0.141 |
| #5 奇異歡星 | 3 | 3 / 0.139 | 2 / 0.159 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 肥仔精神 | 1 | 11 / 0.032 | 12 / 0.021 |
| #8 巴閉佬 | 2 | 6 / 0.089 | 3 / 0.125 |
| #13 添喜運 | 3 | 1 / 0.172 | 1 / 0.218 |

Overrated Top-2 review: #6 志醒大將 (actual 12, p=0.170).
Pre-race signal review: #12 肥仔精神: no ≥3-point above-field Matrix dimension；#8 巴閉佬: race_shape 78.6 (+18.0 vs field), sectional 65.5 (+5.8 vs field)；#13 添喜運: race_shape 82.0 (+21.4 vs field), stability 65.0 (+13.5 vs field).
Cause assessment: challenger reordering or race-specific residual.
Systematicity: this pattern occurs in 14 weak races; any change must still improve multiple chronological folds and external evidence.
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 㩒住贏 | 1 | 7 / 0.072 | 8 / 0.047 |
| #11 富國兄弟 | 2 | 5 / 0.088 | 3 / 0.148 |
| #3 手機錶勁 | 3 | 1 / 0.177 | 5 / 0.099 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 團結勇士 | 1 | 6 / 0.082 | 4 / 0.106 |
| #13 幸運糖 | 2 | 9 / 0.050 | 9 / 0.038 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #4 錶之星河 | 1 | 3 / 0.146 | 2 / 0.171 |
| #2 翠紅 | 2 | 4 / 0.096 | 6 / 0.072 |
| #12 威利金箭 | 3 | 5 / 0.095 | 5 / 0.076 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 焦點 | 1 | 2 / 0.137 | 1 / 0.186 |
| #3 駟跑得 | 2 | 10 / 0.048 | 9 / 0.054 |
| #12 華美之威 | 3 | 9 / 0.053 | 11 / 0.041 |

Overrated Top-2 review: #11 龍又生 (actual 10, p=0.215).
Pre-race signal review: #1 焦點: race_shape 78.8 (+16.2 vs field), stability 68.6 (+12.6 vs field)；#3 駟跑得: no ≥3-point above-field Matrix dimension；#12 華美之威: horse_health 73.2 (+4.5 vs field).
Cause assessment: available pre-race Matrix signals did not place enough contenders in the competitive tier.
Systematicity: this pattern occurs in 36 weak races; any change must still improve multiple chronological folds and external evidence.
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 快樂高球 | 1 | 9 / 0.054 | 7 / 0.077 |
| #11 東方寶寶 | 2 | 3 / 0.116 | 4 / 0.088 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 巴閉精 | 1 | 2 / 0.171 | 1 / 0.150 |
| #3 利高八斗 | 2 | 3 / 0.152 | 2 / 0.147 |
| #2 鼓浪好友 | 3 | 11 / 0.035 | 8 / 0.059 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 自動自覺 | 1 | 5 / 0.087 | 8 / 0.065 |
| #4 實力加 | 2 | 6 / 0.054 | 5 / 0.078 |
| #3 八仟好運 | 3 | 3 / 0.125 | 4 / 0.096 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 夢照發 | 1 | 3 / 0.129 | 3 / 0.104 |
| #7 佰勝金龍 | 2 | 9 / 0.038 | 8 / 0.049 |
| #5 超開心 | 3 | 1 / 0.227 | 1 / 0.188 |
...
| #13 飛躍成就 | 2 | 10 / 0.039 | 12 / 0.033 |
| #7 洪才 | 3 | 4 / 0.113 | 2 / 0.136 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 星火燎原 | 1 | 9 / 0.050 | 8 / 0.070 |
| #8 星辰千帥 | 2 | 8 / 0.072 | 7 / 0.073 |
| #4 佐治傳奇 | 3 | 1 / 0.188 | 1 / 0.190 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 有情有義 | 1 | 1 / 0.286 | 1 / 0.244 |
| #10 北海盜 | 2 | 4 / 0.081 | 3 / 0.093 |
| #3 財富非凡 | 3 | 6 / 0.064 | 4 / 0.087 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 紫辰之星 | 1 | 3 / 0.118 | 3 / 0.150 |
| #4 泰力 | 2 | 9 / 0.034 | 6 / 0.053 |
| #5 做好自己 | 3 | 5 / 0.083 | 5 / 0.070 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 威力非凡 | 1 | 4 / 0.102 | 1 / 0.119 |
| #14 勁爽 | 2 | 13 / 0.040 | 13 / 0.041 |
| #6 神駒馬靈 | 3 | 2 / 0.111 | 3 / 0.097 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 大回報 | 1 | 1 / 0.183 | 1 / 0.155 |
| #13 幸運威龍 | 2 | 5 / 0.071 | 4 / 0.087 |
| #4 逍遙騎士 | 3 | 4 / 0.090 | 3 / 0.090 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 煌上 | 1 | 1 / 0.177 | 1 / 0.134 |
| #13 閃電小子 | 2 | 8 / 0.047 | 10 / 0.039 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 超勁赤兔 | 1 | 3 / 0.116 | 2 / 0.127 |
| #4 凌登 | 2 | 1 / 0.196 | 1 / 0.208 |
| #5 一世美麗 | 3 | 4 / 0.112 | 3 / 0.126 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 朗日自強 | 1 | 3 / 0.110 | 3 / 0.129 |
| #11 天下寵兒 | 2 | 9 / 0.056 | 10 / 0.052 |
| #9 頑童 | 3 | 11 / 0.028 | 11 / 0.050 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 穿甲金鷹 | 1 | 1 / 0.292 | 1 / 0.257 |
| #6 智勇名駒 | 2 | 9 / 0.034 | 9 / 0.044 |
| #5 納百川 | 3 | 7 / 0.064 | 7 / 0.070 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 風采人生 | 1 | 1 / 0.211 | 1 / 0.264 |
| #8 花好月盈 | 2 | 4 / 0.138 | 3 / 0.132 |
| #7 牛精新星 | 3 | 5 / 0.060 | 8 / 0.044 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 幸運愉快 | 1 | 4 / 0.115 | 6 / 0.086 |
| #12 精益大師 | 2 | 11 / 0.030 | 10 / 0.040 |
| #6 新力 | 3 | 8 / 0.069 | 5 / 0.090 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 八駿巨昇 | 1 | 10 / 0.032 | 9 / 0.043 |
| #1 馬力 | 2 | 1 / 0.199 | 1 / 0.166 |
| #2 燭光晚餐 | 3 | 3 / 0.121 | 3 / 0.132 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #4 首駿 | 1 | 2 / 0.098 | 3 / 0.097 |
| #3 金風萬里 | 2 | 3 / 0.089 | 2 / 0.111 |
| #12 快馬加鞭 | 3 | 5 / 0.071 | 7 / 0.066 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 星運少爵 | 1 | 2 / 0.232 | 2 / 0.223 |
| #4 喵喵怪 | 2 | 8 / 0.033 | 8 / 0.034 |
| #5 銳目 | 3 | 4 / 0.111 | 4 / 0.127 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 挺秀弘利 | 1 | 5 / 0.078 | 4 / 0.086 |
| #6 八仟好運 | 2 | 1 / 0.152 | 2 / 0.116 |
| #7 北極之錶 | 3 | 3 / 0.129 | 3 / 0.115 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 喜慶寶 | 1 | 2 / 0.152 | 4 / 0.117 |
| #5 魔術控制 | 2 | 10 / 0.031 | 10 / 0.047 |
| #9 威利金箭 | 3 | 4 / 0.116 | 3 / 0.118 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 家樂寶駒 | 1 | 6 / 0.067 | 4 / 0.120 |
| #1 竣誠駒 | 2 | 3 / 0.126 | 3 / 0.127 |
| #10 龍又生 | 3 | 1 / 0.154 | 2 / 0.129 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 高高至高 | 1 | 4 / 0.098 | 4 / 0.097 |
| #7 準希望 | 2 | 3 / 0.173 | 1 / 0.198 |
| #6 得意佳作 | 3 | 6 / 0.059 | 9 / 0.051 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 風火猴王 | 1 | 7 / 0.084 | 5 / 0.089 |
| #11 友得盈 | 2 | 9 / 0.074 | 8 / 0.065 |
| #5 勝多多 | 3 | 6 / 0.087 | 7 / 0.067 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 鴻圖新星 | 1 | 1 / 0.218 | 1 / 0.220 |
| #5 美麗登場 | 2 | 3 / 0.128 | 4 / 0.110 |
| #8 天火同人 | 3 | 4 / 0.101 | 3 / 0.127 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 爆竹 | 1 | 8 / 0.043 | 8 / 0.046 |
| #3 紅海勁 | 2 | 6 / 0.060 | 5 / 0.088 |
| #1 上浦福旺 | 3 | 2 / 0.185 | 1 / 0.200 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 烈焰光芒 | 1 | 3 / 0.137 | 3 / 0.130 |
| #4 日馳千里 | 2 | 6 / 0.068 | 4 / 0.100 |
| #3 風采人生 | 3 | 1 / 0.276 | 1 / 0.234 |
...
Classification: **ML reordering degraded Matrix contender**. Predictability review: **normal-result cohort**. Venue 跑馬地, Turf, 1800m, Class 4.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 極光之子 | 1 | 10 / 0.032 | 10 / 0.024 |
| #11 將義 | 2 | 3 / 0.153 | 2 / 0.147 |
| #2 川河耀駒 | 3 | 6 / 0.071 | 5 / 0.109 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 觀眾之力 | 1 | 1 / 0.230 | 1 / 0.237 |
| #1 東來欣賞 | 2 | 3 / 0.153 | 2 / 0.182 |
| #4 馬達 | 3 | 5 / 0.077 | 5 / 0.067 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 鄉村樂韻 | 1 | 2 / 0.169 | 1 / 0.163 |
| #4 果然僥倖 | 2 | 8 / 0.039 | 9 / 0.052 |
| #12 朗日雪峰 | 3 | 5 / 0.106 | 5 / 0.096 |
...
| #11 華麗再贏 | 2 | 1 / 0.193 | 1 / 0.139 |
| #9 遨遊波士 | 3 | 4 / 0.105 | 4 / 0.101 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 巴閉精 | 1 | 1 / 0.274 | 1 / 0.208 |
| #6 利高八斗 | 2 | 3 / 0.141 | 3 / 0.119 |
| #1 鼓浪好友 | 3 | 4 / 0.074 | 4 / 0.104 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 太陽勇士 | 1 | 4 / 0.113 | 4 / 0.120 |
| #7 一起美麗 | 2 | 2 / 0.199 | 2 / 0.178 |
| #1 睿盛人生 | 3 | 5 / 0.074 | 5 / 0.086 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 櫻花酒杯 | 1 | 3 / 0.142 | 3 / 0.118 |
| #3 綠野飛馳 | 2 | 2 / 0.151 | 2 / 0.150 |
| #4 超勁赤兔 | 3 | 6 / 0.069 | 8 / 0.064 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 極速神影 | 1 | 7 / 0.057 | 7 / 0.059 |
| #7 致力之城 | 2 | 3 / 0.152 | 2 / 0.134 |
| #9 紅海旺 | 3 | 11 / 0.043 | 5 / 0.070 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 包裝明將 | 1 | 3 / 0.110 | 2 / 0.106 |
| #5 祥勝鷹駒 | 2 | 2 / 0.114 | 4 / 0.077 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 超和平 | 1 | 6 / 0.053 | 5 / 0.062 |
| #3 鋁神 | 2 | 1 / 0.249 | 1 / 0.191 |
| #11 馬鳳凰 | 3 | 12 / 0.034 | 9 / 0.051 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 逍遙騎士 | 1 | 2 / 0.155 | 3 / 0.132 |
| #4 包裝戰仕 | 2 | 7 / 0.040 | 11 / 0.034 |
| #12 好運年 | 3 | 5 / 0.071 | 5 / 0.083 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 正極 | 1 | 6 / 0.093 | 4 / 0.100 |
| #5 千杯敬典 | 2 | 8 / 0.054 | 7 / 0.066 |
| #8 合夥智能 | 3 | 7 / 0.067 | 9 / 0.048 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 佰勝金龍 | 1 | 3 / 0.091 | 2 / 0.094 |
| #14 禾道威 | 2 | 4 / 0.088 | 3 / 0.092 |
| #4 安可 | 3 | 1 / 0.266 | 1 / 0.198 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #10 午夜快車 | 1 | 5 / 0.071 | 6 / 0.070 |
| #12 林寶精神 | 2 | 10 / 0.042 | 11 / 0.046 |
| #4 超加加 | 3 | 3 / 0.105 | 3 / 0.104 |
...
| #4 老鼠斑 | 2 | 6 / 0.062 | 9 / 0.055 |
| #1 怡昌光輝 | 3 | 5 / 0.083 | 4 / 0.082 |
...
| #7 魔術控制 | 2 | 3 / 0.125 | 3 / 0.108 |
| #3 天天同樂 | 3 | 4 / 0.118 | 4 / 0.100 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 精英雄心 | 1 | 2 / 0.141 | 2 / 0.125 |
| #14 正義波 | 2 | 10 / 0.045 | 11 / 0.051 |
| #12 都靈福星 | 3 | 11 / 0.037 | 7 / 0.065 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 拉合爾 | 1 | 3 / 0.127 | 2 / 0.146 |
| #3 凝聚美麗 | 2 | 8 / 0.049 | 5 / 0.073 |
| #7 赤兔再世 | 3 | 4 / 0.106 | 4 / 0.078 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 團結勇士 | 1 | 7 / 0.078 | 7 / 0.081 |
| #12 幸運糖 | 2 | 1 / 0.154 | 1 / 0.125 |
| #2 會長之寶 | 3 | 3 / 0.120 | 3 / 0.110 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 嵐臣 | 1 | 2 / 0.137 | 2 / 0.121 |
| #4 美麗大獎 | 2 | 3 / 0.130 | 3 / 0.111 |
| #7 龍城強將 | 3 | 9 / 0.044 | 9 / 0.055 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 旌採 | 1 | 1 / 0.192 | 1 / 0.183 |
| #11 幸運威龍 | 2 | 8 / 0.055 | 8 / 0.058 |
| #12 君達得 | 3 | 3 / 0.117 | 4 / 0.105 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 一生好彩 | 1 | 3 / 0.175 | 2 / 0.182 |
| #2 活力拍檔 | 2 | 1 / 0.240 | 1 / 0.184 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 馬達 | 1 | 3 / 0.164 | 3 / 0.143 |
| #4 金金小子 | 2 | 7 / 0.056 | 7 / 0.071 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #4 扶搖勢勁 | 1 | 2 / 0.220 | 1 / 0.193 |
| #6 巴基之勝 | 2 | 5 / 0.079 | 5 / 0.109 |
| #3 競駿輝煌 | 3 | 4 / 0.130 | 4 / 0.150 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 三代至醒 | 1 | 11 / 0.033 | 11 / 0.040 |
| #4 卓越蒨鋒 | 2 | 1 / 0.170 | 1 / 0.159 |
| #13 飛躍成就 | 3 | 3 / 0.120 | 2 / 0.102 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 致力之城 | 1 | 2 / 0.176 | 2 / 0.178 |
| #6 砂漿麒星 | 2 | 8 / 0.040 | 8 / 0.057 |
| #11 瑤瑤日上 | 3 | 9 / 0.039 | 7 / 0.057 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 實力股 | 1 | 4 / 0.090 | 5 / 0.073 |
| #6 巴閉精 | 2 | 1 / 0.294 | 2 / 0.253 |
| #12 辣得準 | 3 | 3 / 0.102 | 3 / 0.099 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 萬眾開心 | 1 | 1 / 0.169 | 1 / 0.201 |
| #1 鄉村樂韻 | 2 | 5 / 0.094 | 10 / 0.061 |
| #5 洛河 | 3 | 7 / 0.066 | 6 / 0.079 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 暴風之子 | 1 | 4 / 0.092 | 5 / 0.095 |
| #6 贏玥 | 2 | 6 / 0.077 | 9 / 0.045 |
| #8 越駿聯歡 | 3 | 5 / 0.085 | 4 / 0.100 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 福進 | 1 | 2 / 0.145 | 3 / 0.141 |
| #4 美麗登場 | 2 | 4 / 0.139 | 5 / 0.099 |
| #8 天火同人 | 3 | 3 / 0.143 | 2 / 0.157 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 至合拍 | 1 | 1 / 0.157 | 1 / 0.169 |
| #2 路路勁 | 2 | 6 / 0.070 | 6 / 0.083 |
| #12 頑童 | 3 | 7 / 0.067 | 5 / 0.084 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #8 舞林寶典 | 1 | 9 / 0.041 | 11 / 0.036 |
| #1 燭光晚餐 | 2 | 5 / 0.100 | 4 / 0.092 |
| #3 品德寶寶 | 3 | 3 / 0.144 | 6 / 0.073 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 特別美麗 | 1 | 4 / 0.086 | 7 / 0.075 |
| #11 龍又生 | 2 | 2 / 0.127 | 2 / 0.103 |
| #2 光輝歲月 | 3 | 3 / 0.088 | 5 / 0.085 |
...
| #9 嘉應駿昇 | 2 | 10 / 0.025 | 13 / 0.029 |
| #10 遨遊波士 | 3 | 3 / 0.131 | 3 / 0.138 |
...
| #12 快樂高球 | 2 | 2 / 0.143 | 2 / 0.130 |
| #1 渡月橋 | 3 | 3 / 0.138 | 4 / 0.118 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #13 名揚四海 | 1 | 7 / 0.066 | 6 / 0.078 |
| #4 一生好彩 | 2 | 1 / 0.138 | 2 / 0.121 |
| #12 大回報 | 3 | 5 / 0.109 | 4 / 0.093 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 鵲橋飛昇 | 1 | 10 / 0.048 | 7 / 0.073 |
| #2 銳行星 | 2 | 2 / 0.152 | 3 / 0.120 |
| #6 永福 | 3 | 6 / 0.077 | 8 / 0.073 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #4 君子 | 1 | 12 / 0.022 | 12 / 0.027 |
| #6 老鼠斑 | 2 | 8 / 0.058 | 10 / 0.034 |
| #2 心雄雄 | 3 | 3 / 0.113 | 3 / 0.121 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 龍傲綾羅 | 1 | 1 / 0.161 | 6 / 0.095 |
| #7 文明福星 | 2 | 5 / 0.087 | 1 / 0.141 |
| #3 將傲 | 3 | 10 / 0.040 | 9 / 0.045 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #13 金鑽精靈 | 1 | 5 / 0.070 | 10 / 0.045 |
| #8 好運年 | 2 | 12 / 0.037 | 8 / 0.074 |
| #11 君達得 | 3 | 13 / 0.034 | 12 / 0.029 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #4 上浦福旺 | 1 | 11 / 0.031 | 12 / 0.024 |
| #10 滿洛城 | 2 | 5 / 0.102 | 3 / 0.102 |
...
| #3 縱橫天下 | 2 | 10 / 0.037 | 7 / 0.064 |
| #1 競駿非凡 | 3 | 9 / 0.053 | 10 / 0.043 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 馬達 | 1 | 3 / 0.140 | 2 / 0.160 |
| #1 小霸王 | 2 | 9 / 0.048 | 6 / 0.079 |
| #2 志滿同行 | 3 | 2 / 0.173 | 1 / 0.200 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 齊歡最樂 | 1 | 4 / 0.113 | 5 / 0.098 |
| #10 捷足奔馳 | 2 | 6 / 0.059 | 6 / 0.065 |
| #7 香港精神 | 3 | 9 / 0.036 | 10 / 0.040 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 小魔怪 | 1 | 7 / 0.053 | 7 / 0.064 |
| #10 天天更好 | 2 | 2 / 0.157 | 1 / 0.177 |
| #8 你知我寶 | 3 | 4 / 0.101 | 3 / 0.104 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #10 傑出雷霆 | 1 | 2 / 0.140 | 3 / 0.142 |
| #11 有備而戰 | 2 | 12 / 0.017 | 12 / 0.033 |
| #2 星月飛雲 | 3 | 3 / 0.129 | 2 / 0.152 |
...
Classification: **ML reordering degraded Matrix contender**. Predictability review: **abnormal/outsider flagged**. Venue 沙田, Turf, 1400m, Class 4.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #10 臻至辰 | 1 | 10 / 0.038 | 10 / 0.065 |
| #8 超輕鬆 | 2 | 4 / 0.078 | 2 / 0.107 |
| #6 三甲之星 | 3 | 7 / 0.055 | 5 / 0.077 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 財將 | 1 | 6 / 0.087 | 7 / 0.080 |
| #7 鴻圖新星 | 2 | 2 / 0.154 | 2 / 0.134 |
| #5 紅錢到 | 3 | 10 / 0.046 | 11 / 0.038 |
...
| #7 扶搖勢勁 | 2 | 3 / 0.081 | 5 / 0.093 |
| #1 天天同樂 | 3 | 9 / 0.060 | 6 / 0.075 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 金快飛飛 | 1 | 4 / 0.113 | 4 / 0.095 |
| #1 包裝明將 | 2 | 6 / 0.084 | 6 / 0.081 |
| #2 嵐臣 | 3 | 2 / 0.116 | 2 / 0.106 |
...
| #2 巧眼光 | 2 | 4 / 0.095 | 3 / 0.100 |
| #14 有你有我 | 3 | 6 / 0.056 | 4 / 0.088 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 包裝天王 | 1 | 1 / 0.172 | 2 / 0.136 |
| #11 銀刺勇士 | 2 | 4 / 0.077 | 11 / 0.046 |
| #9 北極之錶 | 3 | 14 / 0.035 | 9 / 0.049 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 仁仁有餘 | 1 | 3 / 0.112 | 3 / 0.111 |
| #8 馬上盈 | 2 | 5 / 0.072 | 6 / 0.072 |
| #9 共創歡欣 | 3 | 8 / 0.061 | 10 / 0.045 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 勁大威猛 | 1 | 6 / 0.076 | 5 / 0.085 |
| #13 勁好運 | 2 | 7 / 0.074 | 4 / 0.089 |
| #8 幸運派彩 | 3 | 12 / 0.035 | 13 / 0.035 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 浪漫勇士 | 1 | 1 / 0.297 | 1 / 0.227 |
| #5 數字天文 | 2 | 5 / 0.071 | 4 / 0.110 |
| #2 大怪奇 | 3 | 7 / 0.065 | 9 / 0.061 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 本能 | 1 | 7 / 0.050 | 4 / 0.087 |
| #11 東方福寶 | 2 | 10 / 0.037 | 11 / 0.039 |
| #10 星之願 | 3 | 2 / 0.162 | 2 / 0.163 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 捷足奔馳 | 1 | 3 / 0.132 | 5 / 0.105 |
| #8 幸運同行 | 2 | 2 / 0.140 | 4 / 0.113 |
| #9 美麗多盈 | 3 | 12 / 0.030 | 12 / 0.026 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 小霸王 | 1 | 6 / 0.060 | 6 / 0.074 |
| #5 晶晶日上 | 2 | 7 / 0.055 | 7 / 0.072 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 富裕君子 | 1 | 1 / 0.351 | 1 / 0.262 |
| #12 不假外求 | 2 | 7 / 0.044 | 7 / 0.046 |
| #6 電訊驕陽 | 3 | 12 / 0.023 | 12 / 0.016 |
...
## 2026-06-03 R3 — model Top-2 hits 1, Matrix 0

Classification: **contender captured in Top-5 tier but not Top 2**. Predictability review: **abnormal/outsider flagged**. Venue 跑馬地, Turf, 1200m, Class 4.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 博愛先鋒 | 1 | 2 / 0.147 | 4 / 0.130 |
| #12 有你有我 | 2 | 4 / 0.122 | 6 / 0.099 |
| #4 驕陽雄心 | 3 | 7 / 0.066 | 9 / 0.043 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 先到先得 | 1 | 2 / 0.181 | 3 / 0.127 |
| #1 星願無限 | 2 | 10 / 0.029 | 10 / 0.032 |
| #9 獎星 | 3 | 3 / 0.157 | 2 / 0.187 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 銀亮奔騰 | 1 | 3 / 0.158 | 1 / 0.196 |
| #11 奔放 | 2 | 7 / 0.059 | 6 / 0.065 |
| #4 加州動員 | 3 | 11 / 0.027 | 11 / 0.027 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 飛躍星伴 | 1 | 5 / 0.074 | 3 / 0.096 |
| #1 開心宇宙 | 2 | 11 / 0.040 | 11 / 0.045 |
| #3 超加加 | 3 | 9 / 0.044 | 9 / 0.050 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 部族高手 | 1 | 5 / 0.079 | 3 / 0.089 |
| #10 捷威 | 2 | 4 / 0.084 | 5 / 0.085 |
| #5 好運年 | 3 | 12 / 0.033 | 13 / 0.039 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 超輕鬆 | 1 | 4 / 0.097 | 5 / 0.093 |
| #5 自動自覺 | 2 | 2 / 0.130 | 2 / 0.107 |
| #8 勁無限 | 3 | 5 / 0.085 | 4 / 0.095 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #12 賢者威楓 | 1 | 4 / 0.085 | 5 / 0.087 |
| #4 深心星 | 2 | 7 / 0.070 | 7 / 0.075 |
| #5 龍之悅 | 3 | 6 / 0.076 | 6 / 0.077 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 年年友福 | 1 | 9 / 0.028 | 9 / 0.040 |
| #12 天蓬貓 | 2 | 3 / 0.139 | 3 / 0.144 |
| #2 安可 | 3 | 2 / 0.179 | 2 / 0.154 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #7 文明戰士 | 1 | 7 / 0.081 | 9 / 0.068 |
| #2 葳莉非凡 | 2 | 4 / 0.114 | 4 / 0.116 |
| #3 逍遙人生 | 3 | 3 / 0.115 | 1 / 0.136 |
...
## 2026-06-13 R9 — model Top-2 hits 0, Matrix 1

Classification: **competitive group absent from both Top-5 rankings**. Predictability review: **abnormal/outsider flagged**. Venue 沙田, AWT, 1200m, Class 4.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #10 偵探傳奇 | 1 | 10 / 0.028 | 10 / 0.040 |
| #3 興馳千里 | 2 | 3 / 0.121 | 2 / 0.123 |
| #9 德心知遇 | 3 | 8 / 0.045 | 8 / 0.055 |
...
## 2026-06-21 R6 — model Top-2 hits 1, Matrix 0

Classification: **competitive group absent from both Top-5 rankings**. Predictability review: **abnormal/outsider flagged**. Venue 沙田, Turf, 1400m, Class 4.

| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 金快飛飛 | 1 | 2 / 0.144 | 3 / 0.110 |
| #12 飛躍成就 | 2 | 10 / 0.038 | 10 / 0.049 |
| #4 手機錶能 | 3 | 8 / 0.058 | 9 / 0.067 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 小鳥天堂 | 1 | 5 / 0.080 | 6 / 0.090 |
| #1 錶之銀河 | 2 | 8 / 0.069 | 4 / 0.098 |
| #7 幸運有您 | 3 | 10 / 0.027 | 10 / 0.059 |
...
| #5 安帝 | 2 | 3 / 0.134 | 3 / 0.129 |
| #1 春風萬里 | 3 | 7 / 0.061 | 8 / 0.053 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 美麗同享 | 1 | 1 / 0.139 | 1 / 0.142 |
| #3 光年魅力 | 2 | 7 / 0.086 | 7 / 0.089 |
| #11 浪漫戰神 | 3 | 10 / 0.054 | 10 / 0.065 |
...
| #4 人和家興 | 2 | 10 / 0.034 | 9 / 0.042 |
| #13 包裝天王 | 3 | 2 / 0.154 | 2 / 0.135 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #14 閃電小子 | 1 | 6 / 0.062 | 9 / 0.057 |
| #9 金勝名駒 | 2 | 12 / 0.024 | 11 / 0.038 |
| #1 閃耀天河 | 3 | 5 / 0.084 | 5 / 0.080 |
...
| #4 翠湖烈風 | 2 | 11 / 0.041 | 12 / 0.036 |
| #3 果然僥倖 | 3 | 9 / 0.055 | 11 / 0.055 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 堅先生 | 1 | 1 / 0.184 | 1 / 0.143 |
| #11 香港仔 | 2 | 8 / 0.060 | 9 / 0.049 |
| #7 傑出雷霆 | 3 | 6 / 0.074 | 7 / 0.054 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 金牌活力 | 1 | 7 / 0.073 | 5 / 0.090 |
| #2 友瑩仁 | 2 | 3 / 0.124 | 3 / 0.106 |
| #6 綫路英雄 | 3 | 2 / 0.142 | 2 / 0.133 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 手到再來 | 1 | 7 / 0.070 | 8 / 0.063 |
| #10 東方魅影 | 2 | 1 / 0.140 | 4 / 0.091 |
| #7 志醒大將 | 3 | 9 / 0.051 | 11 / 0.049 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 佛亮老撾 | 1 | 4 / 0.082 | 3 / 0.098 |
| #11 潮流勇駒 | 2 | 6 / 0.062 | 6 / 0.065 |
| #14 順善寶 | 3 | 1 / 0.257 | 1 / 0.203 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 嘉應奇兵 | 1 | 7 / 0.067 | 7 / 0.066 |
| #7 美麗星晨 | 2 | 10 / 0.019 | 10 / 0.027 |
| #8 至尊瑰寶 | 3 | 3 / 0.118 | 3 / 0.115 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 魅力知福 | 1 | 3 / 0.087 | 3 / 0.099 |
| #11 駿先生 | 2 | 7 / 0.040 | 7 / 0.051 |
| #5 朗日雪峰 | 3 | 1 / 0.412 | 1 / 0.313 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #5 添開心 | 1 | 5 / 0.098 | 4 / 0.117 |
| #12 同喜 | 2 | 3 / 0.134 | 3 / 0.138 |
| #6 老鼠斑 | 3 | 1 / 0.243 | 2 / 0.179 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #6 捷威 | 1 | 1 / 0.143 | 1 / 0.135 |
| #9 風起雲湧 | 2 | 4 / 0.109 | 5 / 0.083 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 利高八斗 | 1 | 1 / 0.235 | 1 / 0.186 |
| #6 龍文正道 | 2 | 4 / 0.079 | 6 / 0.060 |
| #1 鼓浪好友 | 3 | 5 / 0.063 | 5 / 0.066 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #1 哥倫布 | 1 | 1 / 0.266 | 2 / 0.191 |
| #7 焦點 | 2 | 4 / 0.116 | 4 / 0.120 |
| #6 準希望 | 3 | 5 / 0.097 | 6 / 0.106 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #9 極光之子 | 1 | 9 / 0.043 | 10 / 0.034 |
| #11 幸運派彩 | 2 | 7 / 0.055 | 7 / 0.072 |
| #10 川河耀駒 | 3 | 12 / 0.016 | 12 / 0.018 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #11 撼天鐵翼 | 1 | 4 / 0.078 | 3 / 0.129 |
| #4 觀眾之力 | 2 | 3 / 0.171 | 4 / 0.118 |
| #3 嘉應勇將 | 3 | 9 / 0.030 | 9 / 0.042 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 金滙千帥 | 1 | 1 / 0.201 | 1 / 0.158 |
| #12 金運齊來 | 2 | 11 / 0.034 | 10 / 0.057 |
| #1 哈羅威 | 3 | 6 / 0.083 | 8 / 0.062 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #2 盈妍威楓 | 1 | 10 / 0.050 | 8 / 0.067 |
| #10 烈進駒 | 2 | 11 / 0.043 | 12 / 0.048 |
| #8 實力加 | 3 | 9 / 0.057 | 10 / 0.053 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 包裝戰仕 | 1 | 3 / 0.101 | 9 / 0.064 |
| #6 新力飆 | 2 | 14 / 0.023 | 14 / 0.030 |
| #5 超開心 | 3 | 1 / 0.148 | 2 / 0.104 |
...
| Horse | Actual | ML rank / p | Matrix rank / p |
|---|---:|---:|---:|
| #3 臻至辰 | 1 | 6 / 0.058 | 5 / 0.083 |
| #12 金快飛飛 | 2 | 5 / 0.076 | 7 / 0.067 |
| #4 泰坦 | 3 | 10 / 0.028 | 10 / 0.041 |
...
Weak races reviewed: **127** (70 normal-result cohort; 57 outsider/incident/injury/abnormal flagged). Races where the challenger improved Top-2 hit count over Matrix: **8**.

| Pattern | Races |
|---|---:|
| contender captured in Top-5 tier but not Top 2 | 77 |
| competitive group absent from both Top-5 rankings | 36 |
| ML reordering degraded Matrix contender | 14 |
