...
def build_skeleton(data):
    ...
    return {
        ...
        'matrix': {
            'stability':       {'score': '[FILL 必須係單一符號：✅/➖/❌]', 'reasoning': '[FILL]'},
            'speed_mass':      {'score': '[FILL 必須係單一符號：✅/➖/❌]', 'reasoning': '[FILL]'},
            'eem':             {'score': '[FILL 必須係單一符號：✅/➖/❌]', 'reasoning': '[FILL]'},
            'trainer_jockey':  {'score': '[FILL 必須係單一符號：✅/➖/❌]', 'reasoning': '[FILL]'},
            'scenario':        {'score': '[FILL 必須係單一符號：✅/➖/❌]', 'reasoning': '[FILL]'},
            'freshness':       {'score': '[FILL 必須係單一符號：✅/➖/❌]', 'reasoning': '[FILL]'},
            'formline':        {'score': '[FILL 必須係單一符號：✅/➖/❌]', 'reasoning': '[FILL]'},
            'class_advantage': {'score': '[FILL 必須係單一符號：✅/➖/❌]', 'reasoning': '[FILL]'},
            'forgiveness_bonus': {'score': '[FILL 必須係單一符號：✅/➖/❌]', 'reasoning': '[FILL]'},
        },
