...
## 季度更新協議 (Season Refresh Protocol)

### 自動觸發機制
1. **Reflector 觸發**：NBA Reflector 喺回測覆盤時，若發現名單中嘅防守者已被交易、退役、或長期傷缺（≥30 場），應喺覆盤報告中標記 `[STALE_DEFENDER: 球員名 — 原因]`。
2. **季前更新**：每年 NBA 新賽季開始前（通常 10 月），由 Agent Architect 或用戶手動觸發更新流程。
3. **交易截止日更新**：每年 NBA 交易截止日後（通常 2 月），檢查所有球員嘅球隊歸屬是否正確。

### 更新流程
1. 查閱 NBA 官方 All-Defensive Team 投票結果（上季）
2. 查閱 DPOY 排名前 10 候選人
3. 搜尋新秀中嘅頂級防守者（如 ROY 候選人中以防守見長者）
4. 移除已退役/海外轉會嘅球員
5. 更新球隊歸屬（交易後）
6. 提交更新後嘅清單畀用戶確認
