...
KNOWN_AGENT_SCRIPTS = {
    ...
    'scrape_draw_stats.py', 'run_prerace_pipeline.py', 'scrape_standard_times.py', 'scrape_race_results.py', 'run_au_prerace_pipeline.py', 'sip_engine.py', 'mc_simulator.py', 'race_compliance_scan.py', 'racing_graph_nodes.py', 'racing_graph_core.py', 'racing_graph_state.py'
}
