...
- [ ] Storage durability cutover：Tennis 4.387 GB snapshots WARM copy／restore已過；D1 108 bets／30 settlements／30 audit live export、空DB restore、WARM同owner-only Google Drive COLD已過；AU／HKJC meeting reader已catalog-aware。尚欠Tennis COLD、NBA／Tennis data-shape reader同nightly production activation。
