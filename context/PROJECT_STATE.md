...
- Stability residual is now operational as an opt-in, checksum-pinned shadow (`--stability-residual-shadow`). It writes separate CSV/JSON and cannot alter the mainline Logic/rank/verdict path.
