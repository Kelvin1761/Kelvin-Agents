...
- Average result-aligned starters per usable race: **10.25**
- Average pre-scratch/analysis field size: **12.21**
- Usable races: **802**
- Excluded races: **3**
- Usable runners: **8222**
- Excluded runners: **27**
...
- Readiness/report build SHA: `4feee216243f36b50880eecbcac9f01edb2afbf7`
...
- Other integrity counts: `{'declared_field_size_mismatch': 285, 'dead_heat_or_duplicate_winner': 2, 'placing_boundary_tie': 1}`
- Whole-race exclusions: `[{'race_id': '2026-05-08|Pakenham|R1', 'reason': 'multiple_recorded_winners_incompatible_with_single_winner_probability_target', 'winner_count': 2}, {'race_id': '2026-06-27|Caulfield|R3', 'reason': 'placing_boundary_tie_incompatible_with_fixed_place_probability_mass', 'expected_places': 3, 'recorded_places': 4}, {'race_id': '2026-07-18|Flemington|R9', 'reason': 'multiple_recorded_winners_incompatible_with_single_winner_probability_target', 'winner_count': 2}]`
- Starting Price exists only as `market_sp_label`; explicit allow-lists prevent it entering model features.

## Race Coverage

- Venue: `{"Ballarat": 16, "Ballarat Synthetic": 17, "Belmont": 8, "Canberra": 7, "Canterbury": 29, "Caulfield": 26, "Caulfield Heath": 16, "Coffs Harbour": 8, "Cranbourne": 23, "Doomben": 25, "Eagle Farm": 45, "Flemington": 126, "Geelong": 25, "Gold Coast": 8, "Gosford": 15, "Hawkesbury": 7, "Hobart": 9, "Ipswich": 7, "Kensington": 7, "Moe": 4, "Moree": 7, "Mount Gambier": 7, "Northam": 8, "Pakenham": 23, "Randwick": 182, "Rosehill Gardens": 56, "Sale": 14, "Sandown Lakeside": 31, "Seymour": 8, "Sunshine Coast": 8, "Warwick Farm": 30}`
- Distance: `{"Middle1500-1800": 182, "Sprint1200-1400": 327, "Sprint<=1100": 179, "Staying1900-2200": 74, "Staying2300+": 40}`
- Class: `{"Benchmark": 321, "BlackType": 83, "Handicap": 86, "Maiden": 109, "Other": 185, "SetWeights": 18}`
- Track condition: `{"Good/Firm": 284, "Heavy": 121, "Soft": 367, "Synthetic": 24, "Unknown": 6}`
...
| `pf_l800_delta_avg` | 46.7% | 53.3% | 0.0% | 1748 | -4.48…23 |
| `pf_l200_delta_avg` | 46.9% | 53.1% | 0.0% | 1045 | -1.48…12.6 |
| `pf_l400_delta_avg` | 46.9% | 53.1% | 0.0% | 1432 | -2.88…15 |
| `pf_tempo_qrank_avg` | 46.9% | 53.1% | 0.0% | 727 | 0.0067…1 |
| `same_track_place_rate` | 47.7% | 52.3% | 0.0% | 22 | 0…1 |
| `current_jockey_place_rate` | 48.7% | 51.3% | 0.0% | 69 | 0…1 |
| `current_jockey_win_rate` | 48.7% | 51.3% | 0.0% | 64 | 0…1 |
| `same_distance_place_rate` | 52.7% | 47.3% | 0.0% | 27 | 0…1 |
| `rating` | 71.7% | 28.3% | 2.0% | 92 | 31…153 |
| `near_distance_place_rate` | 77.6% | 22.4% | 0.0% | 33 | 0…1 |
| `pf_early_race_pace` | 80.6% | 19.4% | 0.0% | 6 | — |
| `pf_early_runner_pace` | 80.6% | 19.4% | 0.0% | 6 | — |
| `shape_consensus` | 82.3% | 17.7% | 0.0% | 3 | — |
| `pf_race_time_diff_avg` | 82.7% | 17.3% | 0.0% | 2591 | -5.49…20.6 |
| `class_move` | 90.9% | 9.1% | 0.0% | 5 | — |
| `recent_finish_best_3` | 91.8% | 8.2% | 0.0% | 10 | 1…10 |
| `recent_finish_mean_3` | 91.8% | 8.2% | 0.0% | 37 | 1…10 |
| `recent_finish_mean_5` | 91.8% | 8.2% | 0.0% | 90 | 1…10 |
| `recent_place_rate_5` | 91.8% | 8.2% | 0.0% | 11 | 0…1 |
| `recent_win_rate_5` | 91.8% | 8.2% | 0.0% | 11 | 0…1 |
| `weight` | 94.3% | 5.7% | 3.0% | 40 | 49…76.5 |
| `pf_l600_delta_avg` | 94.4% | 5.6% | 0.0% | 2673 | -10.9…17.7 |
| `days_since_last_run` | 94.8% | 5.2% | 0.0% | 310 | 2…784 |
| `trainer_ly_place_rate` | 97.2% | 2.8% | 0.0% | 2125 | 0…1 |
| `trainer_ly_win_rate` | 97.2% | 2.8% | 0.0% | 1806 | 0…0.5 |
| `jockey_ly_place_rate` | 99.3% | 0.7% | 0.0% | 1854 | 0.0435…0.6 |
| `jockey_ly_win_rate` | 99.3% | 0.7% | 0.0% | 1768 | 0…0.4 |
...
| `leaf_class_score` | 100.0% | 0.0% | 22.6% | 28 | 47.7…67.5 |
...
| `leaf_formline_score` | 100.0% | 0.0% | 10.8% | 127 | 53…100 |
...
| `leaf_jockey_score` | 100.0% | 0.0% | 0.7% | 1453 | 32.7…94.4 |
...
| `leaf_pace_figure_score` | 100.0% | 0.0% | 5.9% | 4705 | 0…100 |
...
| `leaf_pace_map_score` | 100.0% | 0.0% | 1.6% | 560 | 50.6…64 |
...
| `leaf_performance_quality_score` | 100.0% | 0.0% | 0.0% | 3747 | 0…100 |
...
| `leaf_rating_score` | 100.0% | 0.0% | 1.8% | 2098 | 47…73.5 |
...
| `leaf_sectional_score` | 100.0% | 0.0% | 46.1% | 26 | 60…100 |
...
| `leaf_trainer_score` | 100.0% | 0.0% | 3.1% | 1896 | 25.2…97.6 |
