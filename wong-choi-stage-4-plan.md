...
- [ ] 10. 完成Stage 4D durability cutover：artifact catalog／verified archive executor、D1 WARM＋owner-only Google Drive COLD、catalog fail-closed resolver、AU／HKJC meeting readers已完成；Tennis 4.387 GB WARM copy＋restore已通過。尚欠Tennis COLD、NBA／Tennis data-shape reader同nightly launchd production activation。→ Verify：外置碟offline只defer；hash／SQLite／D1 restore一致；刪本機前另有scoped approval。
