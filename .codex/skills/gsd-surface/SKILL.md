...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/tmp/antigravity-gsd-local/.codex/.gsd-surface.json`
(sibling to `C:/tmp/antigravity-gsd-local/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/tmp/antigravity-gsd-local/.codex/skills/gsd-*/`.
...
(`~/.codex`), NOT the skills sub-directory (`C:/tmp/antigravity-gsd-local/.codex/skills`).
...
`C:/tmp/antigravity-gsd-local/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/tmp/antigravity-gsd-local/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/tmp/antigravity-gsd-local/.codex/.gsd-surface.json`
Install profile marker: `C:/tmp/antigravity-gsd-local/.codex/.gsd-profile`
Skill dirs: `C:/tmp/antigravity-gsd-local/.codex/skills/gsd-*/`
Engine module: `C:/tmp/antigravity-gsd-local/.codex/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/tmp/antigravity-gsd-local/.codex/gsd-core/bin/lib/clusters.cjs`
</execution_context>
