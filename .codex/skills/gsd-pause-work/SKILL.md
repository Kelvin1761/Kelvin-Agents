...
<execution_context>
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/pause-work.md
</execution_context>
...
Read and execute `C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/session-report.md` end-to-end.
