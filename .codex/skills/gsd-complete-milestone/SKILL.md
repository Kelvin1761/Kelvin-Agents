...
- @C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/complete-milestone.md (main workflow)
- @C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/milestone-archive.md (archive template)
  </execution_context>
