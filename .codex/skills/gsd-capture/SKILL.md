...
<execution_context>
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/add-todo.md
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/note.md
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/add-backlog.md
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/plant-seed.md
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/check-todos.md
