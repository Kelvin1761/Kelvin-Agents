...
Use template from `C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/UI-SPEC.md`.
...
Read template: `C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/UI-SPEC.md`
