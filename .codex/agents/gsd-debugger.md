...
<required_reading>
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/tmp/antigravity-gsd-local/.codex
                  → checks C:/tmp/antigravity-gsd-local/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/tmp/antigravity-gsd-local/.codex/gsd-core
                  → writes to C:/tmp/antigravity-gsd-local/.codex/gsd-core/hooks/
...
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/thinking-models-debug.md
...
- Read @C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/common-bug-patterns.md
