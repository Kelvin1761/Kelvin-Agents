...
Reference full template: `C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/state.md`.
