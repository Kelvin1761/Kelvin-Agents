...
```
Agent(
  prompt="Read C:/tmp/antigravity-gsd-local/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/VALIDATION.md`
