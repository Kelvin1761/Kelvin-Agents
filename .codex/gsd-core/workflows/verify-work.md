...
<template>
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/transition.md`.
...
- Follow @C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/diagnose-issues.md
