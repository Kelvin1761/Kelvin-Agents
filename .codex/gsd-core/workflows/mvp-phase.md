...
<required_reading>
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/user-story-template.md
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/spidr-splitting.md
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/spidr-splitting.md`. Briefly:
