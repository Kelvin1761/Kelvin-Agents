...
```markdown
Read C:/tmp/antigravity-gsd-local/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/tmp/antigravity-gsd-local/.codex/agents/gsd-ui-checker.md for instructions.
