...
INSTALL_JS_GLOBAL="C:/tmp/antigravity-gsd-local/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/tmp/antigravity-gsd-local/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
