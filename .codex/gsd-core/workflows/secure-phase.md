...
```
Agent(
  prompt="Read C:/tmp/antigravity-gsd-local/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/SECURITY.md`
