...
Key references:
- @C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/ui-brand.md (display patterns)
- @C:/tmp/antigravity-gsd-local/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/tmp/antigravity-gsd-local/.codex/gsd-core/USER-PROFILE.md"
...
```bash
cp "C:/tmp/antigravity-gsd-local/.codex/gsd-core/USER-PROFILE.md" "C:/tmp/antigravity-gsd-local/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/tmp/antigravity-gsd-local/.codex/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/user-profiling.md`
...
Reference: @C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to C:/tmp/antigravity-gsd-local/.codex/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to C:/tmp/antigravity-gsd-local/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/tmp/antigravity-gsd-local/.codex/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at C:/tmp/antigravity-gsd-local/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/tmp/antigravity-gsd-local/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="C:/tmp/antigravity-gsd-local/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    C:/tmp/antigravity-gsd-local/.codex/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   C:/tmp/antigravity-gsd-local/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        C:/tmp/antigravity-gsd-local/.codex/AGENTS.md
```
