...
<required_reading>
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/ai-frameworks.md
@C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/tmp/antigravity-gsd-local/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/tmp/antigravity-gsd-local/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/tmp/antigravity-gsd-local/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/tmp/antigravity-gsd-local/.codex/agents/gsd-eval-planner.md for instructions.
