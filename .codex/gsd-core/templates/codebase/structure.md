...
- Usage: Reference from command with `@C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/tmp/antigravity-gsd-local/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/tmp/antigravity-gsd-local/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
