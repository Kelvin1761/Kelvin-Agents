...
<!-- For checkpoint task examples and patterns, see @C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/checkpoints.md -->
...
See `C:/tmp/antigravity-gsd-local/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/tmp/antigravity-gsd-local/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/tmp/antigravity-gsd-local/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
